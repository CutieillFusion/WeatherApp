...
# - all components positions and sizes are hardcoded in weather_management. Could be stored in a json file but that tends to make modifiying more frustrating from my experience
